...
- **沙箱防护** — 将 Bot 进程限制在操作系统级沙箱内（macOS Seatbelt / Linux seccomp），沙箱被绕过时自动恢复
...
| 沙箱     | macOS Seatbelt / Linux seccomp |
...
| `sandbox/` | 操作系统沙箱管理 — 生成并应用 Seatbelt/seccomp 策略 |
