...
class _ProtectionMonitorLogPanelState extends State<ProtectionMonitorLogPanel> {
            ...
            children: [
              if (group.decisionStatus.isNotEmpty &&
                ...
                _buildMetaChip(
                  ...
                  value: _buildSecurityDecisionValue(l10n, group),
                ),
  ...
  String _buildSecurityDecisionValue(
    AppLocalizations l10n,
    TruthRecordModel group,
  ) {
    ...
    final label = _isZh(l10n) ? '判断准则' : 'Judgment Criteria';
    final localized = criteria
        .map((item) => _localizeJudgmentCriteria(l10n, item))
        .toList();
  ...
  String _localizeJudgmentCriteria(AppLocalizations l10n, String criteria) {
    if (!_isZh(l10n)) {
      switch (criteria) {
