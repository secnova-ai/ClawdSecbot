...
class PluginService {
  ...
  Future<ScanResult> scan() async {
    ...
    try {
      ...
      try {
        ...
        final resultJson = transport.callRawNoArg('ScanAssetsFFI');
      ...
      try {
        ...
        try {
          final hashesResult = transport.callRawNoArg('GetScannedSkillHashes');
        ...
        final riskJsonString = transport.callRawOneArg(
          'AssessRisksFFI',
          scannedHashesJson,
        );
  ...
  Future<Map<String, dynamic>> mitigateRisk(
    ...
    try {
      ...
      final resJson = transport.callRawOneArg(
        'MitigateRiskFFI',
        jsonEncode(req),
      );
