...
// that have been migrated from openclaw to core packages.
// This allows remaining openclaw code and tests to compile without mass refactoring.
...
// toJSONString is a utility function used across multiple openclaw files.
